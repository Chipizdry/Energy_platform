...
Revision ID: b0657baecf1f
Revises: ffb99a9e3727
Create Date: 2025-07-17 12:18:54.803618
...
revision: str = 'b0657baecf1f'
down_revision: Union[str, None] = 'ffb99a9e3727'
...
def upgrade() -> None:
    ...
    op.add_column('energetic_schedule', sa.Column('charge_battery_value', sa.Integer(), nullable=True, comment='заряжать батарею в этом режиме с каким то током'))
